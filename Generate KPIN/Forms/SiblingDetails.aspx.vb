...
Partial Class SiblingDetails
    ...
    Dim DetailsValue As String = TITLE_SiblingDetails
    ...
    Protected Sub ButtonSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonSave.Click
        Try
            ...
            If GenerateVPIN() Then
                LabelSiblingDetails.Text = CommonObj.ShowMessageBox(DataUpdated, DetailsValue)
                Response.Redirect("RedirecttoDetails.aspx?Details=" & DropDownListDetails.SelectedValue, False)
            Else
                LabelSiblingDetails.Text = CommonObj.ShowMessageBox(TransactionError, DetailsValue)
            End If
    ...
    Private Function ValidationMemberInfo() As Boolean
        Try
            ...
            If errorMessage <> "" Then
                LabelSiblingDetails.Text = errorMessage
                Return True
            End If

            If WebUserControlDateofBirth.ValidateDate() Then
                LabelSiblingDetails.Text = "Incorrect Date. Please specify correct Date of Birth"
                Return True
            End If
    ...
    Private Function GenerateVPIN() As Integer
        Try
            ...
            Query = "Insert Into SiblingDetails " & _
        ...
        Try
            ...
            If TextBoxSNo.Text <= CommonObj.returnDataSet.Tables(0).Rows.Count Then
                ...
                If CommonObj.returnDataSet.Tables(0).Rows.Count > 0 Then
                    LabelSiblingDetails.Text = "Selected Record cannot be deleted as Record exists for it."
                Else
                    Query = "Delete from SiblingDetails where PinId = " & PinId.ToString() & " and " & _
                    "Name = '" & Name & "'"
                    CommonObj.EstablishSQLConnection(Query)
                    ...
                    LabelSiblingDetails.Text = CommonObj.ShowMessageBox(RecordDeleted, DetailsValue)
                    Response.Redirect("RedirecttoDetails.aspx?Details=" & DropDownListDetails.SelectedValue, False)
                End If
            Else
                LabelSiblingDetails.Text = CommonObj.ShowMessageBox(RecordNotExists, DetailsValue)
            End If
